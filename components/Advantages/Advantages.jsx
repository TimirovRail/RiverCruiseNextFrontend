...
const Advantages = () => {
    return (
        <div className="advantages">
            <h2 className="h1-title">Достоинства и Преимущества</h2>
            <div className="advantages-cards">
                <div className="advantage-card">
                    <FaAnchor className="advantage-icon" />
                    <h3 className="advantage-card-title">Уникальные маршруты</h3>
                ...
                <div className="advantage-card">
                    <FaCompass className="advantage-icon" />
                    <h3 className="advantage-card-title">Комфортабельные условия</h3>
                    <p className="advantage-card-description">
                        Наша команда создает идеальные условия для отдыха. Наслаждайтесь комфортом и уютом, словно на роскошной яхте.
                    </p>
                </div>
                <div className="advantage-card">
                    <FaCocktail className="advantage-icon" />
                    <h3 className="advantage-card-title">Развлекательная программа</h3>
                    <p className="advantage-card-description">
                ...
                <div className="advantage-card">
                    ...
                    <h3 className="advantage-card-title">Экологический туризм</h3>
                    <p className="advantage-card-description">
